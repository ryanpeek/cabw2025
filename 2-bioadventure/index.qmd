...
For our data, we’ll be using an **`inner_join`** that combines datasets by shared keys ( {{<  fa arrows-turn-right >}} <span style="color:orange;">for an overview of the other types of joins, see [R4DS lesson here](https://r4ds.had.co.nz/relational-data.html#mutating-joins) </span>).
